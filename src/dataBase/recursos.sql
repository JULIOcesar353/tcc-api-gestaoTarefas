...
SELECT 
    t.tar_id, t.tar_titulo, t.tar_descricao, t.tar_prioridade, t.tar_prazo, t.tar_status, t.tar_estimativa_minutos, t.tar_data_criacao, t.tar_exige_foto,
    s.set_id, s.set_nome,
...
SELECT 
    at.atr_id, at.atr_data_atribuicao,
